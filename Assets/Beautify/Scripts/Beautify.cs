...
namespace BeautifyEffect {
    ...
    public class Beautify : MonoBehaviour {
								...
								public bool forceARGB32 {
												get { return _forceARGB32; }
												set {
																if (_forceARGB32 != value) {
																				_forceARGB32 = value;
																				UpdateMaterialProperties ();
																}
												}
        ...
        Material
								...
								const string BEAUTIFY_BUILD_HINT = "BeautifyBuildHint552b3";
								...
								void OnEnable () {
												...
												if (EditorPrefs.GetInt (BEAUTIFY_BUILD_HINT) == 0) {
																...
																EditorUtility.DisplayDialog ("Beautify Update: User Action Required", "Beautify shaders have been updated. Please check the Build Options section in Beautify's inspector for shader capabilities and disable/enable features to optimize build size and compilation time.\n\nOtherwise when you build the game it will take a long time during shader compilation!", "Ok");
												}
#endif
								}
...
//																_sunFlares = false;
								...
								void UpdateMaterialPropertiesNow () {
												...
												#if UNITY_EDITOR
												if (_forceARGB32 && EditorUserBuildSettings.activeBuildTarget == BuildTarget.Android) {
												#else
												if (_forceARGB32 && Application.platform == RuntimePlatform.Android) {
												#endif
