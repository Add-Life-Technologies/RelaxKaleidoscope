...
namespace BeautifyEffect {
				...
				public class BeautifyEffectInspector : Editor {
								...
								SerializedProperty _quality, _preset, _compareMode, _compareLineAngle, _compareLineWidth, _profile, _forceARGB32;
								...
								void OnEnable () {
												...
												_forceARGB32 = serializedObject.FindProperty ("_forceARGB32");
...
//												#endif
												...
												EditorGUILayout.PropertyField (_forceARGB32, new GUIContent ("Force ARGB32", "Uses ARGB32 format for temporary render textures instead of floating point textures to avoid a limitation with some old Android GPUs (Mali T720). This option reduces precision and only is applied on Android platform. You may want to include this option in your game settings."));
